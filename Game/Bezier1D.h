...
public:
	...
	void AddFirstSegment(glm::vec4 p0, glm::vec4 p1, glm::vec4 p2, glm::vec4 p3);  // adds a segment at the end of the curve
    ...
    static const std::vector<glm::mat4> &getSegments();
